...
class _PhotoScreenState extends State<PhotoScreen> {
  ...
  Widget build(BuildContext context) {
    WebDataController webCon = Get.find<WebDataController>();
     webCon.photoScreenController.runJavaScript(
      '''
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          //     url: Uri.parse('https://dewansaadaltamimi.com/photos/'),
          //   ),
          ...
          //      setState(() {
          //       _progress = progress / 100; // Normalize progress to 0-1 range
          //     });
          //      if (progress == 100) {
          //       // Request is completed and HTML data is received
          //      controller.evaluateJavascript(source: _injectJavascriptCode());
          //     }
          //   },
          // ),
          //  if (_isLoading)
          ...
          //     ),
          //   ),
          WebViewWidget(controller: webCon.photoScreenController)
        ],
      ),
